...
<div className="hidden md:flex items-center gap-3">
  ...
  <button onClick={onContact} className="flex items-center gap-2 px-4 py-2 rounded-full bg-nikaia-600 hover:bg-nikaia-700 transition-colors duration-200 text-white text-sm font-medium" data-testid="navbar-cta">
    Diagnostic Gratuit
  </button>
</div>
