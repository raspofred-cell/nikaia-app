...
export default function AutomatisationCannesClient() {
    ...
    <div className="min-h-screen bg-[#050505] text-white">
      ...
      <div className="max-w-4xl mx-auto px-6 py-32">
        ...
        <p className="text-sm uppercase tracking-widest mb-4" style={{ color: '#de0917' }}>
          Automatisation & IA · Cannes · Alpes-Maritimes
        </p>

        <h1 className="text-4xl md:text-6xl font-bold tracking-tight mb-8">
          Automatisation intelligente<br />
          <span style={{ color: '#de0917' }}>pour les entreprises de Cannes</span>
        </h1>

        <p className="text-xl text-gray-400 leading-relaxed mb-12">
          NikaIA Automations accompagne les PME, TPE, artisans et entreprises du BTP de Cannes et des
          Alpes-Maritimes dans l'automatisation de leurs tâches répétitives — devis, relances clients,
          rapports de chantier, plannings, facturation. Basé à Nice, nous intervenons directement à Cannes.
        </p>

        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
          <div className="bg-neutral-900/50 border border-white/10 rounded-2xl p-8">
            <h2 className="text-2xl font-semibold mb-4">Pourquoi automatiser votre entreprise à Cannes ?</h2>
            <p className="text-gray-400 leading-relaxed">
              Les entreprises cannoise font face aux mêmes défis : administration chronophage,
          ...
          <div className="bg-neutral-900/50 border border-white/10 rounded-2xl p-8">
            ...
            <p className="text-gray-400 leading-relaxed">
              Basé à Nice, Fred Raspo se déplace régulièrement à Cannes et dans tout le 06.
          ...
          <div className="bg-neutral-900/50 border border-white/10 rounded-2xl p-8">
            <h2 className="text-2xl font-semibold mb-4">Nos solutions à Cannes</h2>
          ...
          <div className="bg-neutral-900/50 border border-white/10 rounded-2xl p-8">
            <h2 className="text-2xl font-semibold mb-4">Secteurs accompagnés à Cannes et dans le 06</h2>
            <ul className="text-gray-400 leading-relaxed space-y-2">
        ...
        <div className="text-center bg-neutral-900/50 border border-white/10 rounded-2xl p-12">
          <h2 className="text-3xl font-bold mb-4">Diagnostic gratuit à Cannes</h2>
          <p className="text-gray-400 mb-8 max-w-xl mx-auto">
            Vous êtes basé à Cannes ou dans les Alpes-Maritimes ? On se rencontre,
          ...
          <p className="text-gray-600 text-sm mt-4">
            Cannes · Alpes-Maritimes · Région PACA · Réponse sous 24h
          </p>
        </div>
