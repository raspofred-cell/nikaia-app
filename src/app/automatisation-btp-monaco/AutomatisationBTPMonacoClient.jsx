...
export default function AutomatisationBTPMonacoClient() {
    ...
    <div className="min-h-screen bg-[#050505] text-white">
      ...
      <div className="max-w-4xl mx-auto px-6 py-32">
        ...
        <p className="text-sm uppercase tracking-widest mb-4" style={{ color: '#de0917' }}>
          Automatisation BTP · Construction · Monaco
        </p>
        ...
        <p className="text-xl text-gray-400 leading-relaxed mb-12">
          ...
          construction à Monaco et sur la Côte d'Azur. Devis, rapports de chantier, relances clients,
          plannings — on automatise tout ce qui vous fait perdre du temps.
        </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
          ...
          <div className="bg-neutral-900/50 border border-white/10 rounded-2xl p-8">
            ...
            <p className="text-gray-400 leading-relaxed">
              ...
              directeur technique. Basé à Nice, il intervient à Monaco et connaît vos contraintes
              de l'intérieur.
            </p>
          </div>
          ...
          <div className="bg-neutral-900/50 border border-white/10 rounded-2xl p-8">
            <h2 className="text-2xl font-semibold mb-4">Secteurs BTP accompagnés à Monaco</h2>
            <ul className="text-gray-400 leading-relaxed space-y-2">
        ...
        <div className="text-center bg-neutral-900/50 border border-white/10 rounded-2xl p-12">
          <h2 className="text-3xl font-bold mb-4">Diagnostic gratuit pour votre entreprise BTP à Monaco</h2>
          <p className="text-gray-400 mb-8 max-w-xl mx-auto">
            Basé à Nice à quelques minutes de Monaco, on intervient en Principauté et sur toute
            la Côte d'Azur. On analyse vos process et on vous propose un plan d'action concret. Sans engagement.
          </p>
          <button
