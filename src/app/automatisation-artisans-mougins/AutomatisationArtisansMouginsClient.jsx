...
export default function AutomatisationArtisansMouginsClient() {
    ...
    <div className="min-h-screen bg-[#050505] text-white">
      ...
      <div className="max-w-4xl mx-auto px-6 py-32">
        ...
        <p className="text-sm uppercase tracking-widest mb-4" style={{ color: '#de0917' }}>
          Automatisation · Artisans · Mougins · Alpes-Maritimes
        </p>

        <h1 className="text-4xl md:text-6xl font-bold tracking-tight mb-8">
          Automatisation pour artisans<br />
          <span style={{ color: '#de0917' }}>à Mougins et dans le 06</span>
        </h1>

        <p className="text-xl text-gray-400 leading-relaxed mb-12">
          Vous êtes artisan à Mougins ou dans les Alpes-Maritimes ? NikaIA automatise vos devis,
          relances, rapports d'intervention et plannings — pour que vous passiez moins de temps
          au bureau et plus de temps sur le terrain.
        </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
          ...
          <div className="bg-neutral-900/50 border border-white/10 rounded-2xl p-8">
            ...
            <p className="text-gray-400 leading-relaxed">
              ...
              il intervient à Mougins et dans tout le 06 avec une connaissance terrain de vos contraintes.
            </p>
          </div>
          ...
          <div className="bg-neutral-900/50 border border-white/10 rounded-2xl p-8">
            <h2 className="text-2xl font-semibold mb-4">Artisans accompagnés à Mougins</h2>
            <ul className="text-gray-400 leading-relaxed space-y-2">
              <li>→ Électriciens</li>
        ...
        <div className="text-center bg-neutral-900/50 border border-white/10 rounded-2xl p-12">
          <h2 className="text-3xl font-bold mb-4">Diagnostic gratuit pour artisans à Mougins</h2>
          <p className="text-gray-400 mb-8 max-w-xl mx-auto">
            On se rencontre à Mougins ou à Nice, on analyse vos process et on vous propose
