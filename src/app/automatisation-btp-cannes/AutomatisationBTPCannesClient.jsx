...
export default function AutomatisationBTPCannesClient() {
    ...
    <div className="min-h-screen bg-[#050505] text-white">
      ...
      <div className="max-w-4xl mx-auto px-6 py-32">
        ...
        <p className="text-sm uppercase tracking-widest mb-4" style={{ color: '#de0917' }}>
          Automatisation BTP · Construction · Cannes · 06
        </p>
        ...
        <p className="text-xl text-gray-400 leading-relaxed mb-12">
          ...
          construction à Cannes et dans les Alpes-Maritimes. Devis, rapports de chantier, relances clients,
          plannings — on automatise tout ce qui vous fait perdre du temps sur le terrain et au bureau.
        </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
          <div className="bg-neutral-900/50 border border-white/10 rounded-2xl p-8">
            ...
            <p className="text-gray-400 leading-relaxed">
              Dans le BTP à Cannes comme ailleurs, les techniciens perdent des heures à rédiger
              des rapports à la main. Les devis partent en retard. Les relances s'oublient.
              Les donneurs d'ordre exigent des documents conformes — sans ça, les paiements bloquent.
            </p>
          </div>
          ...
          <div className="bg-neutral-900/50 border border-white/10 rounded-2xl p-8">
            ...
            <p className="text-gray-400 leading-relaxed">
              ...
              ce qui vous freine, à Cannes comme sur toute la côte.
            </p>
          </div>
          ...
          <div className="bg-neutral-900/50 border border-white/10 rounded-2xl p-8">
            <h2 className="text-2xl font-semibold mb-4">Secteurs BTP accompagnés à Cannes</h2>
            <ul className="text-gray-400 leading-relaxed space-y-2">
        ...
        <div className="text-center bg-neutral-900/50 border border-white/10 rounded-2xl p-12">
          <h2 className="text-3xl font-bold mb-4">Diagnostic gratuit pour votre entreprise BTP à Cannes</h2>
          <p className="text-gray-400 mb-8 max-w-xl mx-auto">
            Basé à Nice, on intervient à Cannes et dans tout le 06.
          ...
          <p className="text-gray-600 text-sm mt-4">
            Cannes · Alpes-Maritimes · Var · Bouches-du-Rhône · Région PACA
          </p>
        </div>
